...
<body>
    <div class="sidebar">
        ...
        <ul class="menu">
            ...
            <li class="active"><a href="pengeluaran.php"><i class="fas fa-chart-bar"></i><span>Pesanan</span></a></li>
            <li><a href="data_user.php"><i class="fas fa-briefcase"></i><span>User</span></a></li>
            <li><a href="data_galon.php"><i class="fas fa-chart-bar"></i><span>Product</span></a></li>
